...
export XLA_FLAGS="--xla_dump_to=./log/llama3/${EXP_NAME}/hlo_dumps --xla_dump_hlo_as_text --xla_dump_hlo_as_dot --xla_dump_hlo_pass_re='spmd-partitioning|while-loop-all-reduce-code-motion' --xla_gpu_enable_cublaslt=true --xla_gpu_enable_triton_gemm=false"
