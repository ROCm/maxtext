...
class HfDataProcessingTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    temp_local_logs = os.path.join("decoupled_datasets", "gcloud_decoupled_test_logs")
    ...
    self.config = pyconfig.initialize(
      ...
      hf_train_files=(
        os.path.join(
          "decoupled_datasets","c4_en_dataset_minimal","hf","c4","c4-train-00000-of-01637.parquet"
