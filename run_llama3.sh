...
EXP_NAME="llama3_8b_fsdp"

mkdir -p ./log/llama3/${EXP_NAME}
mkdir -p ./log/llama3/${EXP_NAME}/hlo_dumps
...
rocprofv3 -d ./log/llama3/${EXP_NAME}/rocprof --hip-trace --kernel-trace --rccl-trace --stats --output-format=pftrace \
    -- python3 -m MaxText.train src/maxtext/configs/gpu/models/llama3_8b.yml > ./log/llama3/${EXP_NAME}/run_logs/run.log 2>&1
